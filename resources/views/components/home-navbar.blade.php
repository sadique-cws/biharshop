...
<div id="avatarButton" type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" class="relative inline-flex items-center justify-center w-10 h-10 overflow-hidden bg-orange-600 rounded-full dark:bg-orange-600" alt="User dropdown">
  <span class="font-medium text-white dark:text-white uppercase">{{substr(auth()->user()->name, 0,2)}}</span>
</div>
...
<a href='{{route('cart')}}' class="relative inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black rounded-lg  ring-1">
  <span>Cart</span>
